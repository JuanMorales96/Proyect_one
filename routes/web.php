...
Route::get('/','App\Http\Controllers\HomeInactiveController@HomeInactive');
...
Route::get('/dashboard/clientes','App\Http\Controllers\ClienteController@LandingCliente')->middleware(['sessionClientes']);
